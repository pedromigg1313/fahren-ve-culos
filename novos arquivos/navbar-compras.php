<header <?php if (empty($float)) {echo 'class="float sticky-top"';}?>>
  <nav class="navbar navbar-expand-lg bg-body shadow-sm" data-bs-theme="light">
    <div class="container-xxl px-lg-5">
      <!-- Logo e botão toggle lado a lado em telas pequenas -->
      ...
      <a class="navbar-brand d-none d-lg-block" href="/sites/TCC">
        <img src="/sites/TCC/img/logo-fahren.png" alt="Logo" width="15" height="20" class="d-inline-block align-text-center" style="filter: invert(1);">
        <span class="ms-1 fw-semibold">Fahren</span>
      </a>
      <button class="navbar-toggler border-0 d-none d-lg-block" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"></span>
      </button>
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <!-- Barra de pesquisa reorganizada para mobile -->
        ...
        <div class="d-flex gap-2 mt-3 mt-lg-0">
          <div class="vr ms-4 d-none d-lg-block"></div>
          <?php
